...
@section('admintitle') Edit Gallery @endsection
...
<div class="col-xl-12 box-margin">
    <div class="card">
        <div class="card-body">
            ...
            <form class="cmxform"  method="post" enctype="multipart/form-data" action="{{route('gallery.update-gallery-post',$gallery->id)}}">
                @csrf
                <fieldset>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <a href="{{asset('web_assets/dynamics/gallery/'.$gallery->image)}}"><img src="{{asset('web_assets/dynamics/gallery/'.$gallery->image)}}" style="width:80px;height:80px;"></a>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text"  class="form-control" name="title"  id="fileInput" value="{{$gallery->title}}">
