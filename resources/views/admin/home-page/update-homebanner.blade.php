...
@section('admintitle') Edit Slider @endsection
...
<div class="col-xl-12 box-margin">
    <div class="card">
        <div class="card-body">
            ...
            <form class="cmxform"  method="post" enctype="multipart/form-data" action="{{route('admin.update-slider-post',$homeslider->id)}}">
                @csrf
                <fieldset>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <a href=""><img src="{{asset('web_assets/dynamics/slider/'.$homeslider->image)}}" style="width:100px;height:100px;"></a>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text"  class="form-control" name="title"  id="fileInput" value="{{ $homeslider->title}}">
                            ...
                            <div class="form-group">
                                <label for="status">Status</label>
                                 <select name="status" id="" class="form-control">
                                    ...
                                    <option value="0" {{$homeslider->status == 0 ? 'selected' : ''}}>Inactive</option>
                                </select>
